local jokerInfo = {
	...
	-- TODO:
		...
		-- "Cirno Dropped His Matcha Ice Cream" dithering between having this be a Rare and an Uncommon. Dithering between the effect of "Sell this Joker during a blind to draw 2x hand size to card", "In X rounds, sell this Joker to multiply your number of discards by 1.5" & "Sell this Joker during a blind to discard all held cards and draw a new hand (If deck is empty, refresh deck)."
		-- Bloodborne on PC Joker: No idea what this could do.
