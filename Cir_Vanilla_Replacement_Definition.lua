...
replaceDef.deckReplacements = { 
	...
	{ dckKey = 'b_zodiac', matureRefLevel = 1, artCreditKey = 'dA_DaemonTsun' },
...
replaceDef.boosterReplacements = { -- These are just in the order Malverk's codebase had them in. Could rearrange them to match the graphic for easier editing.
	...
	{ bstKey = 'p_spectral_mega_1', matureRefLevel = 1, artCreditKey = 'bA_DaemonTsun_BigNTFEdit' },
...
replaceDef.jokerReplacements = {
	...
	{ jkrKey = 'j_order', matureRefLevel = 1, artCreditKey = 'jA_DaemonTsun' },
	...
	{ jkrKey = 'j_to_the_moon', matureRefLevel = 1, artCreditKey = 'jA_NTF' },
...
replaceDef.spectralReplacements = {
	...
	{ spcKey = 'c_cryptid', matureRefLevel = 1, artCreditKey = 'cA_DaemonTsun' },
	{ spcKey = 'c_deja_vu', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
	{ spcKey = 'c_ectoplasm', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
	...
	{ spcKey = 'c_hex', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
	{ spcKey = 'c_immolate', matureRefLevel = 1, artCreditKey = 'gA_Immolate' },
	{ spcKey = 'c_incantation', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
	{ spcKey = 'c_medium', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
...
replaceDef.tagReplacements = {
    ...
    { tagKey = 'tag_voucher', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
    ...
    { tagKey = 'tag_charm', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
...
replaceDef.voucherReplacements = {
    ...
    { vchKey = 'v_seed_money', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
    ...
    { vchKey = 'v_directors_cut', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
    ...
    { vchKey = 'v_reroll_glut', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
    { vchKey = 'v_omen_globe', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
    { vchKey = 'v_observatory', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
    ...
    { vchKey = 'v_money_tree', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
    ...
    { vchKey = 'v_retcon', matureRefLevel = 1, artCreditKey = 'gA_DaemonTsun' },
